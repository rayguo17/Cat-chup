      ...
      <Card body style={{padding:"0px 10px", margin:"0px", border:"2px solid #79D7F6", backgroundColor:"#D4E9F0" }}>
        <Row>
          ...
          <Col xs="2">
            ...
            />
            <p className="username" style={{fontSize:"12px",fontWeight:"500",display:"flex", justifyContent:"space-between", width: "100px" }}>{Info.userName}
            </p>
          </Col>
          <Col xs="10">
            <div>
              <div style={{fontSize:"12px",fontWeight:"500",display:"flex",justifyContent:"space-between", height:"14px"}}>
                <p className="time" style={{ marginLeft:"20px",justifyContent:"flex-start", display:"flex"}}>
                  ...
                  <p style={{marginBlockEnd:"auto",display:"flex",justifyContent:"flex-end",width:"100px" }}>{Info.content.start}</p>
              </div>
          ...
          <CardTitle  style={{marginLeft:"14px"}} tag="h6">{Info.content.title}</CardTitle>
          <div
            style={{
              display: "flex",
