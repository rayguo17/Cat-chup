...
const Post = (props) => {
  ...
  const { id, userInfo, content, postTime, likeNumber, commentsNumber } = props.postInfo

  return (
    <div className="postcard-container">
      <Card >
      <img className="userIcon" src={ userInfo.userIcon_url } alt="icon" />
      <span className="userName"><p> { userInfo.username } </p></span>
      <div className="mood"></div>
        ...
        <CardBody>
          <div className="card-content">
            <img src={ content.picture.data_url } alt="Card image cap" />
          </div>
        </CardBody>
